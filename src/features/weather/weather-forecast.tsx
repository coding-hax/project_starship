 ...
 * no `fetch` here, ADR-0009. The sheet shows no visible title here — the strip
 * itself carries the visible location name — so the module `<h2>` stays
 * visually hidden (issue #972 AK3); the `aria-label` on the `<section>` stays:
 * it names the region with the location and day count, more specific than the
 * generic "Wetter" heading above it.
 */
