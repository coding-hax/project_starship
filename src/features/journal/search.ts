/** One entry's already-decrypted searchable fields (issue #341) — never persisted,
 * only ever held in memory by the session cache that builds this. */
 ...
 * and returns no results. Most recent day first.
 */
