...
5. Legst du als Teil dieses Plans **Folge-/Kind-Tickets** an (z. B. weil das
   ...
   keine existieren, legst du sie an — und zwar mit 'gh issue create --label
   plan' und einem Verweis auf #${issue} im Body (im selben Schritt, wie
   #397 es für Fund-Tickets vorschreibt; nur selbst angelegte, nie fremde).
   So wird jedes Kind selbst geplant und vom Planer-Lauf am Ende auf 'ready'
   gesetzt, statt labellos liegenzubleiben.
