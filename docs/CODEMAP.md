...
scripts/
  ...
  runner/*.test.ts          Vitest-Suiten der TS-Adapter/des Dispatchers/Zeit/Queue/Eskalation/Deckel/PR-Zustände/Nachziehen/Wache, laufen über `pnpm test` mit (#198 S1, #199 S2, #200 S3, #201 S4, #202 S5)
