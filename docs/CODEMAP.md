...
scripts/
  ...
  tests/shim-drift.test.sh  Fixture-Tests (A1-A4): identisch -> kein Drift, veraendert -> Drift, im Ref nicht vorhanden -> kein Fehlalarm, und gesetztes SHIM_DRIFT meldet 🟡 mit Installationsbefehl OHNE den Lauf anzuhalten (#252)
