...
`docs/DESIGN_SYSTEM.md`; ADR-0029, ADR-0030): dieselben Bauteile und dieselbe
Datenlogik, aber die **Anordnung** darf je Route abweichen — in drei Stufen
bis zu drei Spalten (`768px` / `1440px`). Ab der dritten Stufe (≥ 1440px)
rückt zusätzlich der Seitenkopf in eine Zeile zusammen: Beiwerk links, Titel
und Figur rechts. Kein zweiter Komponentenbaum, keine Desktop-only-Features.
Die Bottom-Nav wird ab 768px zur **Sidebar**, dieselbe Reihenfolge.
